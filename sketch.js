...
function setup() {
  ...
  gameoverImage=createSprite(300,100,200,50);
  gameoverImage.addImage("gameover",gameOverImage);
  gameoverImage.scale=0.5;
  restartImage=createSprite(300,150,50,50);
  restartImage.addImage("restart",RestartImage);
